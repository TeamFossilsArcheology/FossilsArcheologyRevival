...
public class FigurineEndermanModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bodyTop.addOrReplaceChild("rightArm", CubeListBuilder.create().texOffs(45, 0).mirror().addBox(-4, -17, 0, 2, 13, 2).mirror(false)
                .texOffs(55, 0).addBox(2, -17, 0, 2, 13, 2), PartPose.offsetAndRotation(0, 15.594f, -6.6344f, -0.3643f, 0, 0));
        ...
        root.addOrReplaceChild("rightArmDestroyed", CubeListBuilder.create().texOffs(65, 1).addBox(4.4f, -4, 0.8f, 2, 13, 2), PartPose.offsetAndRotation(-0.3981f, 19.2f, 4.1105f, -1.5708f, 1.0472f, 0));
