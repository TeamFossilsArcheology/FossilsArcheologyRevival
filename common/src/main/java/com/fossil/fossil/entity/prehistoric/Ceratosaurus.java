...
public class Ceratosaurus extends Prehistoric implements IScaryDinosaur {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("ceratosaurus");
    ...
    public PrehistoricEntityType type() {
        return PrehistoricEntityType.CERATOSAURUS;
    }
