...
public class Ornitholestes extends Prehistoric implements IScaryDinosaur {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("ornitholestes");
    ...
    public PrehistoricEntityType type() {
        return PrehistoricEntityType.ORNITHOLESTES;
    }
