...
public class Phorusrhacos extends Prehistoric implements IScaryDinosaur {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("phorusrhacos");
    ...
    public PrehistoricEntityType type() {
        return PrehistoricEntityType.PHORUSRHACOS;
    }
