...
public class Sarcosuchus extends PrehistoricSwimming implements IScaryDinosaur {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("sarcosuchus");
    ...
    public PrehistoricEntityType type() {
        return PrehistoricEntityType.SARCOSUCHUS;
    }
