...
public class Smilodon extends Prehistoric implements PrehistoricScary {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("smilodon");
    ...
    public PrehistoricEntityType type() {
        return PrehistoricEntityType.SMILODON;
    }
