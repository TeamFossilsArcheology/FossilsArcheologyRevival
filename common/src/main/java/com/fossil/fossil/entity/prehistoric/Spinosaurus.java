...
public class Spinosaurus extends PrehistoricSwimming implements IScaryDinosaur {
    ...
    private static final EntityDataManager.Data data = EntityDataManager.ENTITY_DATA.getData("spinosaurus");
