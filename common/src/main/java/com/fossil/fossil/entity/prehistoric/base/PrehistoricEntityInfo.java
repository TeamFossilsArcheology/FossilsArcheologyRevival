...
public enum PrehistoricEntityInfo implements EntityInfo {
    ...
    AQUILOLAMNA(ModEntities.AQUILOLAMNA, DINOSAUR_AQUATIC, MESOZOIC, 0x9C8278, 0X281F20),
    ...
    DICRANURUS(ModEntities.DICRANURUS, ARTHROPOD, PALEOZOIC, 0X998042, 0X1D1D1D),
    LONCHODOMAS(ModEntities.LONCHODOMAS, ARTHROPOD, PALEOZOIC, 0X904136, 0XF3B2A8),
    SCOTOHARPES(ModEntities.SCOTOHARPES, ARTHROPOD, PALEOZOIC, 0X844343, 0X2F2424),
    WALLISEROPS(ModEntities.WALLISEROPS, ARTHROPOD, PALEOZOIC, 0X503728, 0XBD9346),
