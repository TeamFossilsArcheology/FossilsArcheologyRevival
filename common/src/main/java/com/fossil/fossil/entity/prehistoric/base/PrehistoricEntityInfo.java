...
public enum PrehistoricEntityInfo implements EntityInfo {
    ...
    AQUILOLAMNA(ModEntities.AQUILOLAMNA, DINOSAUR_AQUATIC, MESOZOIC, 0XD6D6D6, 0X3B3B3B),
    ...
    COELACANTH(ModEntities.COELACANTH, FISH, MESOZOIC, 0X363941, 0X9BA1A9),
    ...
    CRASSIGYRINUS(ModEntities.CRASSIGYRINUS, DINOSAUR_AQUATIC, PALEOZOIC, 0XCA773A, 0X8F4B2D),
    DEINONYCHUS(ModEntities.DEINONYCHUS, DINOSAUR, MESOZOIC, 0X2B2424, 0XC8C8C8),
    DIMETRODON(ModEntities.DIMETRODON, DINOSAUR, PALEOZOIC, 0XD6D6D6, 0X3B3B3B),
    DILOPHOSAURUS(ModEntities.DILOPHOSAURUS, DINOSAUR, MESOZOIC, 0X4E5931, 0XF25314),
    DIPLOCAULUS(ModEntities.DIPLOCAULUS, DINOSAUR_AQUATIC, PALEOZOIC, 0XB0A380, 0X7C9694),
    ...
    ICHTHYOSAURUS(ModEntities.ICHTHYOSAURUS, DINOSAUR_AQUATIC, MESOZOIC, 0X2A2632, 0XCEC296),
    ...
    MEGALOGRAPTUS(ModEntities.MEGALOGRAPTUS, ARTHROPOD, PALEOZOIC, 0XB26F45, 0X713719),
    ...
    NAUTILUS(ModEntities.NAUTILUS, FISH, MESOZOIC, 0XC55F47, 0XF5F5F5),
    ...
    PACHYRHINOSAURUS(ModEntities.PACHYRHINOSAURUS, DINOSAUR, MESOZOIC, 0XB6A989, 0X7D5E3A),
    ...
    PLESIOSAURUS(ModEntities.PLESIOSAURUS, DINOSAUR_AQUATIC, MESOZOIC, 0XE4A86E, 0XE17920),
    PROTOCERATOPS(ModEntities.PROTOCERATOPS, DINOSAUR, MESOZOIC, 0XD6D6D6, 0X3B3B3B),
    PSITTACOSAURUS(ModEntities.PSITTACOSAURUS, DINOSAUR, MESOZOIC, 0XD6D6D6, 0X3B3B3B),
    ...
    QUETZALCOATLUS(ModEntities.QUETZALCOATLUS, DINOSAUR, MESOZOIC, 0XD6D6D6, 0X3B3B3B),
    SARCOSUCHUS(ModEntities.SARCOSUCHUS, DINOSAUR_AQUATIC, MESOZOIC, 0X4B4929, 0X8D8C65),
    ...
    STURGEON(ModEntities.STURGEON, FISH, MESOZOIC, 0X655D5B, 0XE6E3E3),
    THERIZINOSAURUS(ModEntities.THERIZINOSAURUS, DINOSAUR, MESOZOIC, 0X322212, 0XCA9C72),
    TIKTAALIK(ModEntities.TIKTAALIK, DINOSAUR_AQUATIC, PALEOZOIC, 0X6A5A1A, 0XD7CF99),
    ...
    DICRANURUS(ModEntities.DICRANURUS, ARTHROPOD, PALEOZOIC, 0XD6D6D6, 0X3B3B3B),
    LONCHODOMAS(ModEntities.LONCHODOMAS, ARTHROPOD, PALEOZOIC, 0XD6D6D6, 0X3B3B3B),
    SCOTOHARPES(ModEntities.SCOTOHARPES, ARTHROPOD, PALEOZOIC, 0XD6D6D6, 0X3B3B3B),
    WALLISEROPS(ModEntities.WALLISEROPS, ARTHROPOD, PALEOZOIC, 0XD6D6D6, 0X3B3B3B),
    TROPEOGNATHUS(ModEntities.TROPEOGNATHUS, DINOSAUR, MESOZOIC, 0XD6D6D6, 0X3B3B3B),
