...
public enum PrehistoricEntityType {
    ...
    AMMONITE(PrehistoricMobType.FISH, TimePeriod.MESOZOIC, Diet.NONE),
    ...
    NYCTOSAURUS(PrehistoricMobType.DINOSAUR, TimePeriod.MESOZOIC, Diet.PISCIVORE, Map.of("eggScale", 0.54f)),
