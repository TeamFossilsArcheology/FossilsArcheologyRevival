...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> ANCIENT_HELMET = ITEMS.register("ancient_helmet", () -> new AncientHelmetItem(ModArmorMaterials.ANCIENT, EquipmentSlot.HEAD, new Item.Properties().tab(ModTabs.FAITEMTAB)));
