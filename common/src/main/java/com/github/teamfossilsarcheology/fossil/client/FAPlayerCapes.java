...
public class FAPlayerCapes {
    public static final Set<UUID> DEV_UUIDS = Set.of(
            ...
            /* SeaManVI */UUID.fromString("fe87a60b-fafe-4bec-ab92-6f489d99e0c4"),
            /* TotallyAHobo */UUID.fromString("e933f353-87d3-4bdb-8afe-bddb4c31b68f")
    );
    public static final Set<UUID> CONTRIBUTOR_UUIDS = Set.of(
            ...
            /* GoodYooserName */UUID.fromString("7423770a-792d-4d02-b068-aacaf19b5b80"),
            /* Helpimdeadinside */UUID.fromString("5182bc80-8680-467a-8c2f-6127231a1977"),
            /* Klubarian */UUID.fromString("57f1201f-5293-495d-a3fb-aa92680ee92a"),
            ...
            /* RecklessBuddha */UUID.fromString("f17aeda8-bb84-44fa-b2fe-f0c9183c603b"),
    ...
    public static final ResourceLocation DEVELOPER_CAPE_TEXTURE = FossilMod.location("textures/skins/developer_cape.png");
    public static final ResourceLocation CONTRIBUTOR_CAPE_TEXTURE = FossilMod.location("textures/skins/contributor_cape.png");
    public static final ResourceLocation DEVELOPER_ELYTRA_TEXTURE = FossilMod.location("textures/skins/developer_elytra.png");
    public static final ResourceLocation CONTRIBUTOR_ELYTRA_TEXTURE = FossilMod.location("textures/skins/contributor_elytra.png");
}
