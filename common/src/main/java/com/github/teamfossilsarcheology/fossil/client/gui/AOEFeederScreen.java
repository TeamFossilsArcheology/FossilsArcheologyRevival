...
public class AOEFeederScreen extends AbstractContainerScreen<AOEFeederMenu> {
    ...
    public AOEFeederScreen(AOEFeederMenu containerMenu, Inventory inventory, Component component) {
