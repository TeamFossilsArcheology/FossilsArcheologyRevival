...
public class CultureVatScreen extends AbstractContainerScreen<CultureVatMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (menu.getFuelTime() > 0) {
            ...
            guiGraphics.blit(TEXTURE, x + 82, y + 36 + FUEL_HEIGHT - scaledProgress, 177, FUEL_HEIGHT - scaledProgress, FUEL_WIDTH, scaledProgress + 1);
        }

        int scaledProgress = menu.getCultivationTime() * PROGRESS_WIDTH / CultureVatMenu.CULTIVATION_DURATION;
        guiGraphics.blit(TEXTURE, x + 78, y + 22, 176, FUEL_HEIGHT+ 2, scaledProgress, PROGRESS_HEIGHT);
