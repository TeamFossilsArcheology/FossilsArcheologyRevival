...
public class WorktableScreen extends AbstractContainerScreen<WorktableMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (menu.isLit()) {
            ...
            guiGraphics.blit(TEXTURE, x + 82, y + 36 + FUEL_HEIGHT - progress, 177, FUEL_HEIGHT - progress, FUEL_WIDTH, progress + 1);
        }
        int progress = menu.getBurnProgress();
        guiGraphics.blit(TEXTURE, x + 76, y + 20, 176, FUEL_HEIGHT + 2, progress, PROGRESS_HEIGHT);
    }
