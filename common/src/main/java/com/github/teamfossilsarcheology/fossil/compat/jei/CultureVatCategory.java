...
public class CultureVatCategory extends WithFuelCategory<CultureVatRecipe> {
    ...
    @Override
    public void draw(@NotNull CultureVatRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull PoseStack poseStack, double mouseX, double mouseY) {
        animatedFuel.draw(poseStack, 42, 21);
        animatedProgress.draw(poseStack, 38, 6);
    }
    ...
    @Override
    public Class<? extends CultureVatRecipe> getRecipeClass() {
        return CultureVatRecipe.class;
    }
}
