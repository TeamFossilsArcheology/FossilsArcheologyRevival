...
public enum PrehistoricEntityInfo implements EntityInfo {
    ...
    CRASSIGYRINUS(ModEntities.CRASSIGYRINUS, DINOSAUR_AQUATIC, PALEOZOIC, 0XCA773A, 0X8F4B2D, bucketable()),
    ...
    DIPLOCAULUS(ModEntities.DIPLOCAULUS, DINOSAUR_AQUATIC, PALEOZOIC, 0XB0A380, 0X7C9694, bucketable()),
    ...
    TIKTAALIK(ModEntities.TIKTAALIK, DINOSAUR_AQUATIC, PALEOZOIC, 0X6A5A1A, 0XD7CF99, bucketable()),
