...
public enum PrehistoricEntityInfo implements EntityInfo {
    ...
    public static void register() {
        for (PrehistoricEntityInfo info : PrehistoricEntityInfo.values()) {
            ...
            if (info.bucketable) {
                registerItem("bucket_item", info, properties -> new ArchitecturyMobBucketItem(info.entitySupplier, () -> Fluids.WATER, () -> SoundEvents.BUCKET_EMPTY_FISH, new Item.Properties().stacksTo(1).tab(ModTabs.FA_MOB_ITEM_TAB)),
