...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> ANCIENT_HELMET = ITEMS.register("ancient_helmet", () -> AncientHelmetItem.get(ModArmorMaterials.ANCIENT, EquipmentSlot.HEAD, new Item.Properties().tab(ModTabs.FAITEMTAB)));
