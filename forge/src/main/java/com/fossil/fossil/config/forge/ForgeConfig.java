...
public class ForgeConfig {
    ...
    static {
        ...
        TAR_SITE_RARITY = intEntry("Rarity of Tar Dig Site Structure. Higher number = more rare", FossilConfig.TAR_SITE_RARITY, 100, 1, 100000000);
        FOSSIL_SITE_RARITY = intEntry("Rarity of Fossil Dig Site Structure. Higher number = more rare", FossilConfig.FOSSIL_SITE_RARITY, 900, 1, 100000000);
        MOAI_RARITY = intEntry("Rarity of Moai Structure. Higher number = more rare", FossilConfig.MOAI_RARITY, 400, 1, 100000000);
        AZTEC_WEAPON_SHOP_RARITY = intEntry("Rarity of Aztec Weapon Shop Structure. Higher number = more rare", FossilConfig.AZTEC_WEAPON_SHOP_RARITY, 400, 1, 100000000);
        TEMPLE_RARITY = intEntry("Rarity of Aztec Temple Structure. Higher number = more rare", FossilConfig.TEMPLE_RARITY, 500, 1, 100000000);
        ACADEMY_RARITY = intEntry("Rarity of Desert Academy Structure. Higher number = more rare", FossilConfig.ACADEMY_RARITY, 3500, 1, 100000000);
        ...
        TAR_SLIMES_SPAWN_RATE = intEntry("True if Tar Slimes are to spawn naturally in tar pits", FossilConfig.TAR_SLIMES_SPAWN_RATE, 75, 1, 100000000);
        NAUTILUS_SPAWN_RATE = intEntry("True if Nautilus are to spawn naturally in oceans", FossilConfig.NAUTILUS_SPAWN_RATE, 6, 1, 100000000);
        COELACANTH_SPAWN_RATE = intEntry("True if Coelacanths are to spawn naturally in oceans", FossilConfig.COELACANTH_SPAWN_RATE, 4, 1, 100000000);
        ALLIGATOR_GAR_SPAWN_RATE = intEntry("True if Alligator Gars are to spawn naturally in swamps", FossilConfig.ALLIGATOR_GAR_SPAWN_RATE, 3, 1, 100000000);
        STURGEON_SPAWN_RATE = intEntry("True if Sturgeons are to spawn naturally in rivers", FossilConfig.STURGEON_SPAWN_RATE, 4, 1, 100000000);
        //BUILDER.pop();
        ...
        DINO_UPDATE_DELAY = boolEntry("Dinosaurs will conduct expensive CPU operations like looking for plants or feeders, once every this number of ticks(with added standard deviation for servers)", FossilConfig.DINO_UPDATE_DELAY, true);
        PREGNANCY_DURATION = boolEntry("How long mammal pregnancies last, in ticks", FossilConfig.PREGNANCY_DURATION, true);
