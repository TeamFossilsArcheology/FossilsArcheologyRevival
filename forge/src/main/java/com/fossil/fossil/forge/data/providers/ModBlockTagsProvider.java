...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        addTag(ModBlockTags.ANCIENT_WOOD_LOGS, ANCIENT_WOOD_PILLAR);
        ...
        addTag(BlockTags.MINEABLE_WITH_PICKAXE,
                ANCIENT_GLASS, REINFORCED_GLASS, FAKE_OBSIDIAN, CULTURE_VAT, ANALYZER, FOSSIL, SKULL_BLOCK, SKULL_LANTERN, BUBBLE_BLOWER,
        ...
        addTag(BlockTags.NEEDS_IRON_TOOL, FOSSIL, PERMAFROST_BLOCK, AMBER_ORE);
