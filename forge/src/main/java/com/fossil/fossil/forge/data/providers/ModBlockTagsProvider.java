...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        addTag(BlockTags.PLANKS, CALAMITES_PLANKS, CORDAITES_PLANKS, MUTANT_TREE_PLANKS, PALM_PLANKS, SIGILLARIA_PLANKS, TEMPSKYA_PLANKS);
        ...
        addTag(BlockTags.WOODEN_STAIRS, CALAMITES_STAIRS, CORDAITES_STAIRS, MUTANT_TREE_STAIRS, PALM_STAIRS, SIGILLARIA_STAIRS, TEMPSKYA_STAIRS);
        addTag(BlockTags.WOODEN_SLABS, CALAMITES_SLAB, CORDAITES_SLAB, MUTANT_TREE_SLAB, PALM_SLAB, SIGILLARIA_SLAB, TEMPSKYA_SLAB);
        ...
        addTag(BlockTags.STAIRS, ANCIENT_STONE_STAIRS, ANCIENT_WOOD_STAIRS, VOLCANIC_BRICK_STAIRS, VOLCANIC_TILE_STAIRS);
        addTag(BlockTags.SLABS, ANCIENT_STONE_SLAB, ANCIENT_WOOD_SLAB, VOLCANIC_BRICK_SLAB, VOLCANIC_TILE_SLAB);
        ...
        addTag(BlockTags.MINEABLE_WITH_PICKAXE, ANCIENT_GLASS, REINFORCED_GLASS, FAKE_OBSIDIAN, CULTURE_VAT, ANALYZER, FOSSIL, SKULL_BLOCK, SKULL_LANTERN, BUBBLE_BLOWER,
        ...
        addTag(BlockTags.NEEDS_IRON_TOOL, FOSSIL, PERMAFROST_BLOCK);
