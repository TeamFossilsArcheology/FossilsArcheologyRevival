...
public class DelightfulCompat {
    public static void registerFoodMappings(FoodMappingsManager manager) {
        ...
        manager.addMeat(DelightfulItems.CHUNK_NUGGET.get()); //These chunk things seem like meat, they are from a mod called Rotten Leather(Delightful has compatability for that mod)
