...
//        manager.addPlant(ModItems.CHORUS_STEW_WOOD.get());
...
//        manager.addMeat(ModItems.ENDER_PAELLA_WOOD.get());
//        manager.addMeat(ModItems.ENDERMITE_STEW.get());
//        manager.addMeat(ModItems.ENDERMITE_STEW_WOOD.get());
//        manager.addPlant(ModItems.PEARL_PASTA.get()); //This is pasta so I will count it as a plant
//        manager.addPlant(ModItems.PEARL_PASTA_WOOD.get());
...
//        manager.addPlant(ModItems.TWISTED_CEREAL_WOOD.get());
