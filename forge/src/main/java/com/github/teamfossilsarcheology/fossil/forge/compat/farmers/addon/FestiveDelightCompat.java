...
public class FestiveDelightCompat {
    public static void registerFoodMappings() {
        ...
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_BASE_FLAKE.get());
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_BASE_SWORD.get());
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_SWORD.get());
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_CREEPER.get());
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_FLAKE.get());
        ...
        FoodMappings.addPlant(FestiveDelightModItems.GINGERBREAD_MAN_CUTTER.get());
