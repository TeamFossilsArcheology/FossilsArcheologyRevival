...
public class FestiveDelightCompat {
    public static void registerFoodMappings(FoodMappingsManager manager) {
        ...
        manager.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_DOUGH_STAR.get(), 10);
        manager.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_DOUGH_BLOCK.get(), 10);
        manager.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_BLOCK.get());
        manager.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_CREEPER.get());
        manager.addPlant(FestiveDelightModItems.GINGERBREAD_COOKIE_STAR.get());
        ...
        manager.addPlant(FestiveDelightModItems.GINGERBREAD.get());
