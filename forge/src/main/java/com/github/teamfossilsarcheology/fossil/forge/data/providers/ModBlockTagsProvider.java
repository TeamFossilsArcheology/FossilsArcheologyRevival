...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        addTag(BlockTags.MINEABLE_WITH_PICKAXE,
                ...
                ANCIENT_GLASS, REINFORCED_GLASS, FAKE_OBSIDIAN, OBSIDIAN_SPIKES, CULTURE_VAT, ANALYZER, FEEDER, AOE_FEEDER, SKULL_BLOCK, SKULL_LANTERN, BUBBLE_BLOWER,
        ...
        addTag(ModBlockTags.UNBREAKABLE, ANCIENT_GLASS, BUBBLE_BLOWER, DENSE_SAND, FEEDER, AOE_FEEDER, REINFORCED_GLASS);
