...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        addTag(ModItemTags.FILTER_MACHINES, BIO_FOSSIL, PlANT_FOSSIL, SHALE_FOSSIL, TAR_FOSSIL, BIO_GOO, POTTERY_SHARD, TAR_DROP, RELIC_SCRAP, ANALYZER, CULTURE_VAT, FEEDER, AOE_FEEDER, SIFTER, WORKTABLE, DRUM);
        ...
        addTag(ModItemTags.FILTER_PARK, BUBBLE_BLOWER, FEEDER, AOE_FEEDER, SKULL_STICK, STUNTED_ESSENCE, CHICKEN_ESSENCE,
                WHIP, DINOPEDIA);
